...
Future Scope: There are still a lot of features I want to add to this portfolio as I keep improving it. One of the main things I want to focus on is upgrading the UI and animations to make everything look smoother and more professional. Another plan is to add more travel locations and photos to the Travel page since that part of the site will keep growing over time. I also want to expand the site by adding new sections, like a blog or a page that highlights more of my personal projects. This will make the website more interactive and show more of my work. I plan to keep improving the overall design, responsive layout, and content as I continue learning new things. The site is already deployed on Netlify, so I will keep updating it and pushing changes as the project evolves.
